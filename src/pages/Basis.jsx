    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-3 md:px-8 text-[#67469c] py-4 basis-content">
        ...
        <p>
          ...
          হিসেবে না হয়ে , ‘Top Class IT Service Provide’ হিসেবে পরিচিত হয়।
        </p>
        ...
        <p>
          দেশের প্রথম ডিজিটাল মার্কেটিং কোম্পানি হিসেবে অ্যানালাইজেন বাংলাদেশ লিমিটেডকে আমরা তৈরি করেছি, শিল্পের সাথে
          প্রযুক্তির একটি সৃজনশীল মিশেলে। প্রায় এক দশক ধরে আমরা কাজ করে আসছি ডিজিটাল মার্কেটিং, ই. আর. পি., বিগ ডাটা,
          আর্টিফিসিয়াল ইন্টেলিজেন্স ও মেশিন লার্নিং নিয়ে। আমরা দিয়ে আসছি অ্যাডভার্টাইজিং টেকনোলোজি সল্যুশন, মার্কেটিং
