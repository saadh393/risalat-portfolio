    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-3 md:px-8 text-[#67469c] py-4 basis-content mt-6">
        ...
        <p>
          ...
          সামনের দিনগুলির পরিকল্পনাটি কী সেটা জানবার পূর্ন অধিকার বর্তায়। আর প্রতিটি প্রার্থীরই তার এই পরিকল্পনা নিয়ে
          স্বচ্ছতা ও জবাবদিহিতা থাকতে হবে।
        </p>

        <p>
          তা নাহলে কোন ভিত্তিতে তারা আমাকে ভোট দেবে! বেসিস নির্বাচন নিশ্চয়ই একটি শুধু নামের জোরে প্রভাব খাটিয়ে, বাহ্যিক
          চাকচিক্য দেখিয়ে, কিংবা খাতিরের সম্পর্ক থেকে ভোট চাইবার জায়গা নয়। এখানে চাই সঠিক দিক নির্দেশনা ও একটি সামগ্রিক
          ভিশন। একটু ধৈর্য্য ধরে আমার সাথে থাকুন। আমি ঠিক সেই বিষয়টি নিয়েই আপনাদের সামনে কথা বলতে এসেছি।
        </p>
      ...
      <div className="max-w-7xl mx-auto px-3 md:px-8 text-[#67469c] py-4 basis-content">
        ...
        <p>
          এইজন্যেই আমরা বলছি তথ্যপ্রযুক্তির সাব-সেক্টর ধরে ধরে নির্দিষ্ট সেক্টরের স্বার্থ সংরক্ষণ করে এমন সুনির্দিষ্ট
          পলিসি অ্যাডভোকেসি। সবার জন্য এক পলিসি কাজ করবে এমন কোনো কথা নেই। একেকজনের একেক ধরনের পলিসির প্রয়োজন হতে পারে।
          আমাদের আইসিটি ইন্ডাস্ট্রির অনেকগুলো জায়গায় এখনো পলিসিই ডেভেলপ হয়নি। সেই পলিসিগুলো ডেভেলপ করতে হবে। বিশেষ করে
          ফ্রন্টিয়ার টেকনোলজি বা সোশ্যাল মিডিয়া অ্যানলিটিকস-এর মতো রিলেটিভলি নিউ সেক্টরগুলো, যেগুলোতে বিভিন্ন পলিসি গত
          কারণে আমরা এই দেশে অনেক কিছু করতে পারি না। ডেটা ক্রলিং, বিভিন্ন প্রাইভেসি ইস্যু, ডিজিটাল অ্যাক্ট- ঝামেলার শেষ
          নেই। আমাদের এমন রেগুলেশন ও গাইডলাইন বানাতে হবে, যেন সোশ্যাল মিডিয়ায় আমাদের সবকিছু আরও অনেক প্রোটেক্টেড হয়।{" "}
        </p>

        <p>
          সাব-সেক্টর ভিত্তিক পলিসি অ্যাডভোকেসির ক্ষেত্রে আসলে ঐ সেক্টরে যে অভিজ্ঞতা ও দক্ষতা রাখেন, তাকে দিয়েই পলিসি
          অ্যাডভোকেসি করাতে হবে। সরকার যখন পলিসি বানাবে, তখন সেখানে আমাদের বেসিস মেম্বারদের বা ইন্ডাস্ট্রির অংশগ্রহন তো
          থাকবেই, সেই অংশগ্রহনও হতে হবে সাব-সেক্টর নির্ভর।
        </p>

        <p>
          এভাবে সাব-সেক্টর ভিত্তিক পলিসি অ্যাডভোকেসি হলে ব্যাপারটা সবার জন্য অনেক স্বচ্ছ ও সহজবোধ্য হবে। পলিসি গুলো অনেক
          বেশি বিনিয়োগ বান্ধব হবে, নতুন নতুন উদ্ভাবনে ভূমিকা রাখবে, এবং আমাদের অর্থনীতিকেও সামনে এগিয়ে নিয়ে যেতে ভূমিকা
          রাখবে। আর এই জিনিসটাই আমরা নিশ্চিত করতে চাই।
        </p>
        ...
        <p>
          ...
          আনার ক্ষেত্রে ১০-১৫% নেট ভ্যালু অ্যাড করছে অপরদিকে তথ্যপ্রযুক্তি খাত কিন্তু ১০০% বিদেশি টাকাটাই ঘরে আনছে, কারণ
          নিজেদের মেধাশ্রম-ই এই খাতে আমাদের বিনিয়োগ। তাই অর্থায়ন ব্যবস্থার আধুনিকায়ন এখন সময়ের দাবি।
        </p>

        <p className="font-bold">
          উপরের এই চারটি সমস্যা থেকে উত্তোরণের পথে যেতে থেকেই, টিমস্মার্ট এর বাকি ইন্ডিভিজ্যুয়াল সদস্যদের মধ্য থেকে একজন
        ...
        <p>
          ...
          অ্যাডমিনিস্ট্রেশনে আমার ডক্টরেট কম্পলিট করেছি।
        </p>

        <p className="font-medium">অসুখ বিসুখের ডাক্তার না কিন্তু আবার! তথ্যপ্রযুক্তির ডক্টর।</p>

        <p>
          দেশের প্রথম ডিজিটাল মার্কেটিং কোম্পানি হিসেবে অ্যানালাইজেন লিমিটেডকে আমরা তৈরি করেছি, শিল্পের সাথে প্রযুক্তির
          একটি সৃজনশীল মিশেলে। তারপর প্রায় এক দশক ধরে আমরা কাজ করে আসছি, ডিজিটাল মার্কেটিং, ই. আর. পি., বিগ ডাটা,
          আর্টিফিসিয়াল ইন্টেলিজেন্স ও মেশিন লার্নিং নিয়ে। আমরা দিয়ে আসছি অ্যাডভার্টাইজিং টেকনোলোজি সল্যুশন, মার্কেটিং
          টেকনোলজি সল্যুশন, চ্যাটবক্স সল্যুশন এর মতো প্রযুক্তিগত সেবা গুলো। আমরা কাজ করেছি এগ্রোটেক নিয়ে এবং কিছুদিন আগে
          মাইক্রোজেন নামে আমরা একটি ফিনটেক সল্যুশন নিয়ে এসেছি যা দিয়ে ব্যাংকিং খাতে ক্ষুদ্রঋণ এর কার্যক্রম পরিচালনা আরো
          সহজতর হবে।
        </p>

        <p>
          এর আগে, ২০০৭ থেকে ২০১৪ সাল পর্যন্ত আমি কাজ করেছি ইউনিলিভারের মতো একটি বহুজাতিক প্রতিষ্ঠানে বাংলাদেশ ও
          সিঙ্গাপুরে ব্র্যান্ড ডেভেলপমেন্ট ও মার্কেটিং নিয়ে। সেই সাথে, পারিবারিক ভাবে সুত্রপাত করা জনাব, এ বি এম
          সিদ্দীক (আমার বাবা) এর কোম্পানি, ক্রান্তি অ্যাসোসিয়েটস লিমিটেড, ১৯৮৯ সাল থেকে যেটা আছে, সেখানে আমি পরিচালক ও
          সিইও হিসেবে কাজ করছি।
        </p>
        ...
        <p>
          ...
          প্রায় ১৪ তা দেশে ২০০ এর বেশি ক্লায়েন্টকে সার্ভ করে আসছি। দেশে বিদেশে আমরা পেয়েছি অসংখ্য স্বীকৃতি এবং
          পুরস্কার। এর মধ্যে একটি পুরস্কারের আলাদা করে বলতে চাই, সেটা হল ২০১৯ সালে BASIS National ICT Awards - এ
          অ্যানালাইজেন থেকে ৩টি ক্যাটাগরিতে ৩টি টেকনোলজি প্রোডাক্ট নিয়ে অংশগ্রহণ করে ৩টিতেই চ্যাম্পিয়ন হই। বাংলাদেশে এখন
          পর্যন্ত এই অনন্য রেকর্ড কেউ ভাঙতে পারেনি।
        </p>
        ...
        <p>
          ...
          আমার একটি সমৃদ্ধ অভিজ্ঞতা হয়েছে। বেসিস-এ ডিজিটাল মার্কেটিং স্ট্যান্ডিং কমিটির চেয়াম্যান হিসেবে ডিজিটাল
          ...
          <br />
          বর্তমানে, পেশাদার কাজের পাশাপাশি, আইবিএ-তে ফুল কোর্স ক্লাস নিচ্ছি এবং আইসিটি ডিভিশনের ACMP প্রোগ্রামে ডিজিটাল
          ট্রান্সফরমেশন, ডিজিটাল মার্কেটিং, ডাটা প্রাইভেসি, বিগ ডাটা এবং মার্কেটিং ফানেল নিয়ে নলেজ ক্রিয়েশন ও নলেজ
          শেয়ারিং নিয়েও কাজ করছি।
        </p>
        ...
        <p>
          ...
          বাংলাদেশ’ কে সত্যিকার ভাবে বিশ্ব দরবারে তুলে ধরতে আপনাদের সকলের সমর্থন, সহযোগিতা ও ভোট চাচ্ছি। নিজ নিজ আলাদা
          দক্ষতা ও সক্ষমতা নিয়ে আমার সাথে আছেন আমাদের টিম স্মার্ট আরো ১০ জন স্বপ্ন- সারথী, যারা প্রত্যেকই নিজ নিজ ব্যবসা
          ক্ষেত্রে একেকজন পাইওনিয়ার। আগামী ২০২৪-২০২৬ মেয়াদের নির্বাচনে আমাদের মেধা, শ্রম ও সময় দিয়ে বেসিস কে গড়ে তুলতে
          চাই দলমত নির্বিশেষে একটি স্বচ্ছ ও জবাবদিহিতামূলক অ্যাসোসিয়েশন এবং ‘স্মার্ট বাংলাদেশ ভিশন ২০৪১’ এর নিউক্লিয়াস।
          <br />
          <br />
          টিম স্মার্ট - স্মার্ট বেসিস এর পথে, একসাথে। আপনারা আমাদের পাশে থাকবেন।
          <br />
          <br />
          ধন্যবাদ।
        </p>
